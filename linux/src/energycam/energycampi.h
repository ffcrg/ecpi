...
//Device Status
#define MODBUS_SLAVE_STATUS_ENERGYCAM_ACTIONONGOING	0x0002
#define MODBUS_SLAVE_STATUS_ENERGYCAM_ACTIONCOMPLETED	0x0003
...
#define MODBUS_SLAVE_OCRCONFIG_READING_EVERY_XMIN_GET(x)	  ((x & 0x07C0) >> 6)
#define MODBUS_SLAVE_HOLDINGREG_MEMMAP_REGOCRCONFIG               ((MODBUS_SLAVE_HOLDINGREG_MEMMAP_FIRST) +  21)
